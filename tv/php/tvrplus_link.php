...
$s="http://index.mediadirect.ro/getUrl?publisher=4&app=tvrplus&file=".$link;
...
$l1="Rtmp-options:-b ".$buf." -a tvrplus/_definst_?id=10668839&publisher=4 -W http://static1.mediadirect.ro/player-preload/swf/tvrplus_1136/player.swf -p http://www.tvrplus.ro";
