...
print $video;
   ...
   if (strpos($h1,"rtmp") === false) {
     ...
     $w="http://d1.a4w.ro/player/flowplayer.cluster-3.2.1.swf";
     $p="http://www.protv.ro";
     //rtmp://vod.protv.ro/vod_all/
     $t1=explode("/",$rtmp);
     $a=$t1[3]."/";
     $l="http://127.0.0.1/cgi-bin/scripts/util/translate.cgi?stream,Rtmp-options:-W http://d1.a4w.ro/player/flowplayer.cluster-3.2.1.swf -p http://www.protv.ro -a ".$a;
     $l=$l." -y".$y.",".$rtmp;
