...
>
  	...
  	<text redraw="yes" offsetXPC="85" offsetYPC="12" widthPC="10" heightPC="6" fontSize="20" backgroundColor="10:105:150" foregroundColor="60:160:205">
		...
		<text align="left" redraw="yes"
          lines="18" fontSize=15
		      offsetXPC=30 offsetYPC=25 widthPC=65 heightPC=65
  ...
  /usr/local/etc/www/cgi-bin/scripts/tv/image/dolce.jpg
    ...
    Necesita un cont pe spicetv.ro.
		</text>
...
if (userInput == "pagedown" || userInput == "pageup")
{
  ...
  url2="http://127.0.0.1/cgi-bin/scripts/tv/spice_link.php?file=" + url1;
  url=getUrl(url2);
...
foreach($videos as $video) {
   ...
   $image=$t2[0];
     ...
     <script>
     showIdle();
     url=geturl("http://127.0.0.1/cgi-bin/scripts/tv/spice_link.php?file='.$link.'");
     movie="http://127.0.0.1/cgi-bin/scripts/util/translate.cgi?stream," + url;
     cancelIdle();
    storagePath = getStoragePath("tmp");
    storagePath_stream = storagePath + "stream.dat";
