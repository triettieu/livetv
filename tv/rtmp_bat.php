...
//$query = $_GET["file"];
$query = "https://raw.githubusercontent.com/giolao/Viet-Simpletv/master/x_playlist.m3u,RTMP+VN";
$query = "playlist.txt,RTMP+VN";
//$query = "http://tv.zing.vn/,RTMP+VN";
if($query) {
